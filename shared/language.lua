lang = {
    target_label = 'Open Creation',
    menu_title = 'Workbench',
    menu2_title = 'Weapon Information Menu',
    menu2_options_1 = 'Create Weapon',
    menu2_options_2 = 'View Weapon Information',
    ...
    menu4_options_2 = 'Speed',
    menu4_options_3 = 'Capacity',
    menu4_options_4 = 'Accuracy',
    menu4_options_5 = 'Range',
